...
def systemDark():
    ...
    return color.red()*0.2126+color.green()*0.7152+color.blue()*0.0722 <= 255.0/2
class LingmoTheme(QObject):
    ...
    def refreshColors(self):
        isDark = self.dark()
        self.primaryColor= LingmoTheme._accentColor._lighter if isDark else LingmoTheme._accentColor._dark
        ...
        self.frameColor= QColor(56, 56, 56, round(255 * 0.8)) if isDark \
                        else QColor(243, 243, 243, round(255 * 0.8))
        self.frameActiveColor= QColor(48, 48, 48, round(255 * 0.8)) if isDark \
                               else QColor(255, 255, 255, round(255 * 0.8))
        self.itemHoverColor= QColor(255, 255, 255, round(255 * 0.06)) if isDark \
                           else QColor(0, 0, 0, round(255 * 0.03))
        self.itemPressColor= QColor(255, 255, 255, round(255 * 0.09)) if isDark \
                           else QColor(0, 0, 0, round(255 * 0.06))
        self.itemCheckColor= QColor(255, 255, 255, round(255 * 0.12)) if isDark \
