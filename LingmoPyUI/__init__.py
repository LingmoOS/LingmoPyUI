...
class LingmoAppBar(LingmoFrame):
	def __init__(self,parent=None,show=True,title='',icon=''):
		...
		self.minimizeNormalColor=self.maximizeNormalColor=LingmoTheme.instance.itemNormalColor
		self.minimizeHoverColor=self.maximizeHoverColor=LingmoTheme.instance.itemHoverColor
		self.minimizePressColor=self.maximizePressColor=LingmoTheme.instance.itemPressColor
